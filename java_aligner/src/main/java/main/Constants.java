...
public class Constants {
	...
	//////////////////////////////////////////////////////
	//
	// The Multimap "data_aware_map" will contain the list of pairs of labels for which it is possibile a replacement activity (del + add)
	// in the data-aware setting. For example, having the following list of pairs (p1, p2) - (p1, p3) - (p1, p4) - (p2, p1) - (p2, p5), the 
	// multimap will be as follows: p1=[p2, p3, p4], p2=[p1,p5], etc.
	//	
	...
	public static void setDataAware_map(Multimap<String, String> data_aware_map) {
		Constants.data_aware_map = data_aware_map;
	}
	/////////////////////////////////////////////////////
	//////////////////////////////////////////////////////
