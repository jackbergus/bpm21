...
struct input_pipeline {
    ...
    lydia_entry_point lydia_script;
    ...
    decompose_genmodel_for_tiny_graphs(std::unordered_set<std::string> &SigmaAll,
                                       const std::string &single_line_file,
                                       bool safely_map_names,
                                       bool use_lydia,
                                       const std::unordered_map<std::string, std::string>& old_to_new = {}) {
        return decompose_ltlf_for_tiny_graphs(final_model,
                                              SigmaAll,
                                              single_line_file,
                                              safely_map_names,
                                              use_lydia,
