...
std::vector<std::vector<std::pair<std::string, std::unordered_map<std::string, std::variant<std::string, double>>>>> load_xes_with_data(const std::string &filename, bool ignore_data = false, bool conservative_for_pddl = true);
